        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight flex items-center gap-2">
                    ...
                    <span>{{ __('Edit Medicine: ') }} {{ $medicine->name }}</span>
                </h2>
                <p class="text-xs text-gray-500 mt-0.5">Update formulation details, classification, price, and reorder limits.</p>
            </div>
            <a href="{{ route('inventory.medicines.show', $medicine) }}" class="px-3.5 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-xs font-semibold transition">
                Back to Details
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl border border-gray-200 shadow-xs p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('inventory.medicines.update', $medicine) }}" class="space-y-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="generic_name" id="generic_name" value="{{ old('generic_name', $medicine->generic_name) }}" required
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 relative rounded-lg shadow-xs">
                                ...
                                <input type="number" step="0.01" min="0" name="unit_price" id="unit_price" value="{{ old('unit_price', $medicine->unit_price) }}" required
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 relative rounded-lg shadow-xs">
                                ...
                                <input type="number" step="0.01" min="0" name="purchase_price" id="purchase_price" value="{{ old('purchase_price', $medicine->purchase_price) }}"
                        ...
                        <div>
                            ...
                            <input type="number" min="0" name="reorder_level" id="reorder_level" value="{{ old('reorder_level', $medicine->reorder_level) }}" required
                        ...
                        <div class="sm:col-span-2 pt-2 border-t border-gray-100">
                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $medicine->is_active) ? 'checked' : '' }}
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                        <a href="{{ route('inventory.medicines.show', $medicine) }}" class="px-4 py-2 text-xs font-semibold text-gray-600 hover:text-gray-800 transition">
                            Cancel
                        </a>
